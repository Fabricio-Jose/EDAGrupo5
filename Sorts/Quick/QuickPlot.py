...
x,y = np.loadtxt('QuickCpp.txt' , delimiter=',' , unpack=True)
x1,y1 = np.loadtxt('QuickPy.txt' , delimiter=',' , unpack=True)
x2,y2 = np.loadtxt('QuickJava.txt' , delimiter=',' , unpack=True)
